...
class CustomerAdmin(admin.ModelAdmin):
    list_display = ("display_name", "line_user_id", "qr_token", "is_registered", "current_point_balance", "is_active", "created_at")
    list_filter = ("is_registered", "is_active")
    search_fields = ("display_name", "line_user_id", "qr_token", "phone_number")
    readonly_fields = ("qr_token", "created_at", "updated_at", "registered_at")
